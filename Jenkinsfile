  ...
  stages {
    ...
    stage('Deploy') {
      steps {
        ...
        sh '''aws --debug s3 cp /var/lib/jenkins/workspace/alexa-ci-cd-apr-18_master/target/alexa-cicd-0.0.1-SNAPSHOT.war s3://elasticbeanstalk-us-east-1-593614531934/2018362ew4-alexa-cicd-0.0.1-SNAPSHOT.war 
'''
