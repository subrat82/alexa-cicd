  ...
  stages {
    ...
    stage('Deploy') {
      steps {
        ...
        sh '''aws --debug s3 cp /var/lib/jenkins/workspace/alexa-cicd/target/alexa-cicd-0.0.1-SNAPSHOT.war s3://elasticbeanstalk-us-west-2-jenkins/alexa-cicd-0.0.1-SNAPSHOT.war '''
